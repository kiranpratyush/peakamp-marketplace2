...
const mockProduct = {
  ...
  images: [
    { src: PRODUCT_IMAGES.NMC, alt: "Modern Chair" },
  ],
  price: "₹28,500 per kg",
  subtitle: "High-quality NMC black mass with optimal composition for battery manufacturing.",
  badge: "Best Seller",
  rating: 4.5,
  summary: "High-quality NMC black mass with optimal composition for battery manufacturing.",
  ...
  accordions: [
  {
    ...
    content: (
      <ul>
        <li>Nickel Content: 25-30%</li>
        <li>Cobalt Content: 15-20%</li>
        <li>Manganese Content: 10-15%</li>
        <li>Lithium Content: 5-7%</li>
      </ul>
    ),
  },
],
