...
import {
  ...
  ProductCardProps,
  ProductCardSkeleton,
} from '@/design-system/primitives/product-card';
import * as Skeleton from '@/design-system/primitives/skeleton';

import { RemoveWishlistItemAction, RemoveWishlistItemButton } from '@/design-system/primitives/wishlist-item-card/remove-wishlist-item';
import { AddWishlistItemToCartAction, WishlistItemAddToCart } from '@/design-system/primitives/wishlist-item-card/wishlist-item-add-to-cart';
